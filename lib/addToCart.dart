      ...
      body: cartItems.isEmpty
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            ...
            subtitle: Text('Quantity: ${item['quantity']},Total Price: \$${item['totalPrice'].toStringAsFixed(2)}'),
            trailing: IconButton(
        ...
        Center(child: Form(
          ...
          child: Column(
            children: <Widget>[
              ...
              SizedBox(width: 200, child: TextFormField(controller: _controllerPhoneNumber,
              ...
              const SizedBox(height: 10),
              SizedBox(width: 200, child: TextFormField(controller: _controllerCity,
                decoration: const InputDecoration(
                  border: OutlineInputBorder(),
                  hintText: 'Enter City',
                ),
              ...
              SizedBox(width: 200, child: TextFormField(controller: _controllerStreet,
                decoration: const InputDecoration(
                  border: OutlineInputBorder(),
              ...
              ElevatedButton(
                ...
                onPressed: _loading ? null : () { // disable button while loading
                  if (_formKey.currentState!.validate()) {
                    ...
                    saveAddress(update, int.parse(_controllerPhoneNumber.text.toString()),
                        _controllerCity.text.toString(),_controllerStreet.text.toString());
                  }
                },
...
Future<void> saveAddress(Function(String) update, int phoneNumber, String city, String street,
    ) async {
  try {
